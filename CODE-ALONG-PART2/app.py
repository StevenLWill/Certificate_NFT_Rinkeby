...
student_account = st.text_input("Enter Account Address", value = account.address)
...
if st.button("Award Certificate"):
    ...
    gas_estimate = w3.eth.estimateGas({"to": account.address, "from": contract_address, "value": 0})
    ...
    st.write('TX Hash: ',signed_tx.rawTransaction)
